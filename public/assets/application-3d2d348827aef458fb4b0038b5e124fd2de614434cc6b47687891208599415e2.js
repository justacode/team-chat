...
(function() {
  App.chat_room = App.cable.subscriptions.create("ChatRoomChannel", {
    ...
    received: function(data) {
      if (data['message']) {
        this.addNewMessage(data['message'], data['user_id']);
      }
      if (data['updated_message']) {
        return this.addUpdatedMessage(data['updated_message']);
      }
    },
    ...
    update: function(message, message_id) {
      return this.perform('edit', {
        updated_message: message,
        message_id: message_id
      });
    },
    addNewMessage: function(message, user_id) {
      var current_user_id, wrap;
      ...
      return $('.messages').append(wrap.html());
    },
    addUpdatedMessage: function(updated_message) {
      var message;
  ...
  $(document).on('keypress', '[data-behaviour~=chat_room_speaker]', function(event) {
    if (event.keyCode === 13) {
  ...
  $(document).on('keypress', '[data-behaviour~=chat_room_editor]', function(event) {
    var message_id;
    if (event.keyCode === 13) {
...
(function() {
  $(document).ready(function() {
    ...
    return $(document).on('click', 'button.edit-msg-btn', function(event) {
      var msg_id;
